...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='\\\\ad.monash.edu\\home\\User023\\bfis0008\\Documents\\Quantum Similarity\\Code\\Colour_Similarity_Experiment-90\\Colour_Similarity_Experiment_90\\Colour_Similarity_Experiment_90_lastrun.py',
...
for thisTrial_3 in trials_3:
    ...
    trials_2 = data.TrialHandler(nReps=1, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Stimconditions.xlsx', selection='0:2'),
